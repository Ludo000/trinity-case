		...
		addMouseOverActorListener(actor, function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				if(!(engine.isPaused()))
				{
					...
					{
						if(((((Engine.engine.getGameAttribute("ask") : String) == "Q1") || ((Engine.engine.getGameAttribute("Levent") : String) == "Q1")) && !((Engine.engine.getGameAttribute("Q1") : Bool))))
						{
						...
						if(((((Engine.engine.getGameAttribute("ask") : String) == "Q2") || ((Engine.engine.getGameAttribute("Levent") : String) == "Q2")) && !((Engine.engine.getGameAttribute("Q2") : Bool))))
						{
							playSound(getSound(156));
							Engine.engine.setGameAttribute("NumDialogue", ((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1));
							Engine.engine.setGameAttribute("ask", "null");
						...
						if(((((Engine.engine.getGameAttribute("ask") : String) == "Q3") || ((Engine.engine.getGameAttribute("Levent") : String) == "Q3")) && !((Engine.engine.getGameAttribute("Q3") : Bool))))
						{
							playSound(getSound(156));
							Engine.engine.setGameAttribute("NumDialogue", ((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1));
							Engine.engine.setGameAttribute("ask", "null");
						...
						if(((((Engine.engine.getGameAttribute("ask") : String) == "Q4") || ((Engine.engine.getGameAttribute("Levent") : String) == "Q4")) && !((Engine.engine.getGameAttribute("Q4") : Bool))))
						{
							playSound(getSound(156));
							Engine.engine.setGameAttribute("NumDialogue", ((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1));
							Engine.engine.setGameAttribute("ask", "null");

	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				if(((Engine.engine.getGameAttribute("NumDialogue") : Float) <= (Engine.engine.getGameAttribute("MaxDialogue") : Float)))
				{
					...
					if(((Engine.engine.getGameAttribute("Levent") : String) == "content"))
					{
						getActor(31).setAnimation("content");
					}
					else if(((Engine.engine.getGameAttribute("Levent") : String) == "colere"))
					{
						getActor(31).setAnimation("colere");
					}
					else if(((Engine.engine.getGameAttribute("Levent") : String) == "mort"))
					{
					...
					else if(((Engine.engine.getGameAttribute("ask") : String) == "ouch"))
					{
		...
		addMouseOverActorListener(getRegion(4), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_1"))
				{
					...
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Blanche : Well if you take it that way ... : colere : reload";
		...
		addMouseOverActorListener(getRegion(5), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				...
				{
					playSound(getSound(224));
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Blanche : Good i'm glad to see we understand each other, it's so rare these days... : normal";
					Engine.engine.setGameAttribute("ShowPrec", -1);
					Engine.engine.setGameAttribute("ShowNext", true);
					getActor(28).disableActorDrawing();
					Engine.engine.setGameAttribute("NumDialogue", ((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1));

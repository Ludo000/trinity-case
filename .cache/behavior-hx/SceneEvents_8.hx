	...
	override public function init()
	{
			...
			if(wrapper.enabled)
			{
				...
				if(((Engine.engine.getGameAttribute("NumDialogue") : Float) <= (Engine.engine.getGameAttribute("MaxDialogue") : Float)))
				{
					...
					if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_1"))
					{
						...
						g.drawString("" + "-It's could be a \"fan\" of the killer.", (getActor(22).getX() + 20), (getActor(22).getY() + 50));
						g.drawString("" + "- It's probably the same killer.", (getActor(22).getX() + 20), (getActor(22).getY() + 80));
						if(_HoverQCMChoix1)
						{
					...
					else if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_2"))
					{
						...
						getActor(22).enableActorDrawing();
						g.setFont(getFont(26));
						g.drawString("" + "- Mr Colibris is probably the killer.", (getActor(22).getX() + 20), (getActor(22).getY() + 50));
						g.drawString("" + "- Mr Colibris is probably an accomplice.", (getActor(22).getX() + 20), (getActor(22).getY() + 80));
						if(_HoverQCMChoix1)
						{
							g.fillColor = Utils.convertColor(Utils.getColorRGB(0,0,0));
							g.strokeSize = 5;
		...
		addMouseOverActorListener(getRegion(4), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_1"))
				{
					...
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Anna:No, the video of the karaoke was never made public.";
				...
				else if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_2"))
				{
					...
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Theodore:The killer didn't make any mistake in the karaoke i don't think he would let that pass without noticing.";
					Engine.engine.setGameAttribute("Perd1Pv", true);
					Engine.engine.setGameAttribute("ShowNext", false);
					Engine.engine.setGameAttribute("ShowPrec", 1);
					getActor(22).disableActorDrawing();
		...
		addMouseOverActorListener(getRegion(5), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				...
				{
					playSound(getSound(224));
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Anna:The murder was recorded like the other on a camera.";
					getActor(22).disableActorDrawing();
					Engine.engine.setGameAttribute("ShowPrec", -1);
				...
				{
					playSound(getSound(156));
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Theodore:Well it seems this guys is the only trail we have.";
					Engine.engine.setGameAttribute("ShowNext", true);
					getActor(22).disableActorDrawing();
					Engine.engine.setGameAttribute("ShowPrec", -1);
					Engine.engine.setGameAttribute("ask", "null");

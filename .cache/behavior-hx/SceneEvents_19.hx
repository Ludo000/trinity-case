	...
	override public function init()
	{
		...
		addWhenDrawingListener(null, function(g:G, x:Float, y:Float, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled)
			{
				...
				{
					if(((Engine.engine.getGameAttribute("PersoFeel") : String) == "normal"))
					{
						getActor(28).setAnimation("normal");
					}
					else if(((Engine.engine.getGameAttribute("PersoFeel") : String) == "triste"))
					{
						getActor(28).setAnimation("triste");
					}

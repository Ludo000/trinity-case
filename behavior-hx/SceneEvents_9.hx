...
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Okay it's for a movie, so what exactly was your part in ?";
}

                    else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:You know I would have believe you if at the end of the 'movie' the women doesn't get brutally murdered, too bad it's not the case.";
}
                ...
                if(Engine.engine.getGameAttribute("Q2"))
{
                    ...
                    if((Engine.engine.getGameAttribute("QKarma") == "good"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:You need protection it's obvious ! But we can only do that if you tell me what you know !";
}

                    else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Okay you can choose not to talk, we got some free room in jail and you appear on a murder record so...";
}
                ...
                if(Engine.engine.getGameAttribute("Q3"))
{
                    ...
                    if((Engine.engine.getGameAttribute("QKarma") == "good"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Yeah really I'll tell the judge you were cooperative.";
                        Engine.engine.getGameAttribute("LineList").splice(Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1)), 1);
}

                    else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Yeah hopefully ! But going to an abandoned house and tie an unconscious women just because a man you met hours before tell you to do it is pretty dumb.";
                        Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:With luck the judge won't convict you for being a moron.";
}
                ...
                else if((Engine.engine.getGameAttribute("page_carnet") == 2))
{
                    Engine.engine.setGameAttribute("ShowFiche", false);
                    g.setFont(getFont(26));
                    g.drawString("" + "Report of the forensic scientist", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(23))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(23),0)), Float));
                    g.drawString("" + "that show that the victim", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(23))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(23),20)), Float));
                    g.drawString("" + "didn't eat for 3 days before her death.", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(23))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(23),40)), Float));
                    g.drawString("" + "DNA dound ont the rope", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(24))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(24),0)), Float));
                    g.drawString("" + "that tied the victim.", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(24))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(24),20)), Float));
                    g.drawString("" + "SD Card, countains video of the scene.", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(25))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(25),0)), Float));
                    if(_hoverpreuve1)
{
                        g.fillColor = Utils.getColorRGB(0,0,0);
                        g.strokeSize = Std.int(5);
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:No we saw on the record Mr Colibris tying the victime minutes before the killer came. If he leaved the house he was with the neighborhood.";
            Engine.engine.setGameAttribute("Perd1Pv", true);
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("ShowPrec", 1);
            getActor(21).disableActorDrawing();
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            playSound(getSound(156));
            Engine.engine.setGameAttribute("ShowNext", true);
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:You're lucky we just find out that couldn't have killed the victime.";
            getActor(21).disableActorDrawing();
            Engine.engine.setGameAttribute("ShowPrec", -1);
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
}

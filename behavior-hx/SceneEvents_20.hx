...
/* ======================== When Creating ========================= */
        ...
        hideTileLayer(1, "" + "bombe2");
        hideTileLayer(1, "" + "bombe3");
        hideTileLayer(1, "" + "bombe4");
            ...
            else if(((Engine.engine.getGameAttribute("ask") == "Q1") && !(Engine.engine.getGameAttribute("Q1"))))
{
            ...
            else if((Engine.engine.getGameAttribute("ask") == "show"))
{
...
{
                    Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Why does Blanche want to kill me?I can help you if you cooperate ! ";
}

                else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                    Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Stop all your little game ! Why do you all want to kill me ? What did I do ?";
}
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:Only one position is right so of course I won't touch this button !";
...
{
            playSound(getSound(224));
            showTileLayer(1, "" + "bombe2");
            Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "himself : BROAM";
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Voice:Umh I think it was the wrong position.";
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 2))] = "Theodore:What ? No...";
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 3))] = "Voice:Good luck with your life from now on you'll need it. : : reload";
            Engine.engine.setGameAttribute("ShowPrec", -1);
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
            Engine.engine.setGameAttribute("ShowNext", true);
}

...
{
                if(((Engine.engine.getGameAttribute("ask") == "Q1") || (Engine.engine.getGameAttribute("Levent") == "Q1")))
{
                ...
                if(((Engine.engine.getGameAttribute("ask") == "Q2") || (Engine.engine.getGameAttribute("Levent") == "Q2")))
{
                    playSound(getSound(156));
                    Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
                    Engine.engine.setGameAttribute("ask", "null");
                ...
                if(((Engine.engine.getGameAttribute("ask") == "Q3") || (Engine.engine.getGameAttribute("Levent") == "Q3")))
{
                    playSound(getSound(156));
                    Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
                    Engine.engine.setGameAttribute("ask", "null");
                ...
                if(((Engine.engine.getGameAttribute("ask") == "Q4") || (Engine.engine.getGameAttribute("Levent") == "Q4")))
{
                    playSound(getSound(156));
                    Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
                    Engine.engine.setGameAttribute("ask", "null");

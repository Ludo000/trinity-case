...
/* ======================== When Creating ========================= */
        ...
        scripts.SceneEvents_3._customBlock_pos_actor_to(getActor(32),Engine.engine.getGameAttribute("pos_choix_centre_x"),Engine.engine.getGameAttribute("pos_choix_centre_y"));
        scripts.SceneEvents_3._customBlock_pos_actor_to(getActor(30),Engine.engine.getGameAttribute("pos_choix_gauche_x"),Engine.engine.getGameAttribute("pos_choix_gauche_y"));
        scripts.SceneEvents_3._customBlock_pos_actor_to(getActor(31),Engine.engine.getGameAttribute("pos_choix_droite_x"),Engine.engine.getGameAttribute("pos_choix_droite_y"));
        _HoverQCMChoix2 = false;
...
{
                    Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Listen an officer life is in danger right now !";
                    Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Police officer:What are you... Okay Okay...";
}

                else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                    Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "himself:BAM";
                    Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:Sorry mate but I really got to go.";
}

}

            if(((Engine.engine.getGameAttribute("ask") == "Q1") || ((Engine.engine.getGameAttribute("ask") == "Q2") || (Engine.engine.getGameAttribute("ask") == "Q3"))))
{
                Engine.engine.setGameAttribute("ShowChoice", true);
                Engine.engine.setGameAttribute("ShowNext", false);
}

            else if((Engine.engine.getGameAttribute("ask") == "reload"))
{
                Engine.engine.setGameAttribute("ShowNext", false);
                reloadCurrentScene(createFadeOut(2, Utils.getColorRGB(0,0,0)), createFadeIn(2, Utils.getColorRGB(0,0,0)));
}

            else if((Engine.engine.getGameAttribute("ask") == "awake"))
{
                showTileLayer(1, "" + "back1");

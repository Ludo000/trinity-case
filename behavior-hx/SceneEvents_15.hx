        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Anna:No we can say that so early, the modu operandi is the same as the mirror killer.";
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:Anyway I got more question for Mr Dubeaufeu.";
            Engine.engine.setGameAttribute("ShowPrec", -1);
            getActor(26).disableActorDrawing();
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Anna:Yeah...I'm not an expert but I think there some chances it's related to the mirror killer...";
            Engine.engine.setGameAttribute("Perd1Pv", true);
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("ShowPrec", 1);
            getActor(26).disableActorDrawing();

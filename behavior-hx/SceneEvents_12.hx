...
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Listen I won't lie to you we know that you killed all these women !";
                        Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:But if you'r cooperative we can make your life easier !";
                        Engine.engine.getGameAttribute("LineList").splice(Std.int((Engine.engine.getGameAttribute("NumDialogue") + 2)), 1);
                        Engine.engine.getGameAttribute("LineList").remove((Engine.engine.getGameAttribute("NumDialogue") + 3));
}

                    else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Good question ! Why are you here ?";
                        Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:In my opinion with all the women you killed you should be in some dark hole.";
                        Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 2))] = "Theodore:But luckily we're interested in your 'friend'.";
                        Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 3))] = "Theodore:So talk and maybe you'll get a bigger hole for the rest of your life!";
}

}

                else if(Engine.engine.getGameAttribute("Q2"))
{
                    Engine.engine.setGameAttribute("Q2", false);
                    if((Engine.engine.getGameAttribute("QKarma") == "good"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:You're obviously ill, tell me who gave the order to you might go to a psychatric hospital after that.";
                        Engine.engine.getGameAttribute("LineList").splice(Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1)), 1);
}

                    else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore:Enough of that !";
                        Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:Tell me the name now !";
}
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:No, he mentioned two women...";
            Engine.engine.setGameAttribute("Perd1Pv", true);
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("ShowPrec", 1);
            getActor(21).disableActorDrawing();
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:Okay Blanche gave the order I get that.";
            getActor(21).disableActorDrawing();
            Engine.engine.setGameAttribute("ShowPrec", -1);
            Engine.engine.setGameAttribute("ask", "null");
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:So a woment told you to kill eleven poor girl?";
            getActor(21).disableActorDrawing();
            Engine.engine.setGameAttribute("ShowPrec", -1);
            Engine.engine.setGameAttribute("ask", "null");
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:No, Sophie was never founded, she is probably dead.";
            Engine.engine.setGameAttribute("Perd1Pv", true);
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("ShowPrec", 1);
            getActor(21).disableActorDrawing();

                ...
                else if(((Engine.engine.getGameAttribute("ask") == "Q1") || ((Engine.engine.getGameAttribute("ask") == "Q2") || (Engine.engine.getGameAttribute("ask") == "Q3"))))
{
                ...
                else if((Engine.engine.getGameAttribute("ask") == "launch"))
{
                    showTileLayer(1, "" + "Poison");
                    _start = true;
propertyChanged("_start", _start);
}
...
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = " Theodore : So, i think the murderer is simply Kevin the roxxor, the cannibal who is related with you by this old case, who was found with you in the cave 20 years ago.";
}

                    else if((Engine.engine.getGameAttribute("QKarma") == "bad"))
{
                        Engine.engine.getGameAttribute("LineList")[Std.int(Engine.engine.getGameAttribute("NumDialogue"))] = "Theodore : Stop joking with me ! This murder is the cannibal who was with you in this cave, where you attacked us, me and my coworker, and he also was foud with you in this old case 20 years ago.";
}
                ...
                else if((Engine.engine.getGameAttribute("page_carnet") == 2))
{
                    Engine.engine.setGameAttribute("ShowFiche", false);
                    g.setFont(getFont(26));
                    g.drawString("" + "Poison found near me.", cast((scripts.SceneEvents_3._customBlock_X_to_the_right_of(getActor(34))), Float), cast((scripts.SceneEvents_3._customBlock_Y_to_the_right_of(getActor(34),0)), Float));
                    if(_hoverpreuve1)
{
                        g.fillColor = Utils.getColorRGB(0,0,0);
                        g.strokeSize = Std.int(5);
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore : Okay I think I got the right one.";
            Engine.engine.setGameAttribute("ShowPrec", -1);
            _QCM1 = true;
propertyChanged("_QCM1", _QCM1);
            Engine.engine.setGameAttribute("ShowNext", true);
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            playSound(getSound(224));
            Engine.engine.setGameAttribute("ask", "null");
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore : Arghh ....";
            Engine.engine.setGameAttribute("ShowPrec", -1);
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
            _mort = true;

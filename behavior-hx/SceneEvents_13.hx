            ...
            if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            else if((Engine.engine.getGameAttribute("ask") == "penta"))
{
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Anna : Why this place in particular ? : serieux_sourire";
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Anna : Why, there are absolutely no reasons... : decu";

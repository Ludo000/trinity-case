...
class SceneEvents_23 extends SceneScript
{
	...
	override public function init()
	{
		...
		scripts.SceneEvents_3._customBlock_pos_actor_to(getActor(32), (Engine.engine.getGameAttribute("pos_choix_centre_x") : Float), (Engine.engine.getGameAttribute("pos_choix_centre_y") : Float));
		scripts.SceneEvents_3._customBlock_pos_actor_to(getActor(30), (Engine.engine.getGameAttribute("pos_choix_gauche_x") : Float), (Engine.engine.getGameAttribute("pos_choix_gauche_y") : Float));
		scripts.SceneEvents_3._customBlock_pos_actor_to(getActor(31), (Engine.engine.getGameAttribute("pos_choix_droite_x") : Float), (Engine.engine.getGameAttribute("pos_choix_droite_y") : Float));
		_HoverQCMChoix2 = false;
		_HoverQCMChoix2 = false;
		_HoverQCMChoix1 = false;
		hideTileLayer(engine.getLayerByName("back1"));
			...
			if(wrapper.enabled)
			{
				...
				if(((Engine.engine.getGameAttribute("NumDialogue") : Float) <= (Engine.engine.getGameAttribute("MaxDialogue") : Float)))
				{
					...
					if((Engine.engine.getGameAttribute("Q1") : Bool))
					{
						...
						{
							(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int((Engine.engine.getGameAttribute("NumDialogue") : Float))] = "Theodore:Listen an officer life is in danger right now !";
							(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Police officer:What are you... Okay Okay...";
						}
						else if(((Engine.engine.getGameAttribute("QKarma") : String) == "bad"))
						{
							(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int((Engine.engine.getGameAttribute("NumDialogue") : Float))] = "himself:BAM";
							(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Theodore:Sorry mate but I really got to go.";
						}
					}
					if((((Engine.engine.getGameAttribute("ask") : String) == "Q1") || (((Engine.engine.getGameAttribute("ask") : String) == "Q2") || ((Engine.engine.getGameAttribute("ask") : String) == "Q3"))))
					{
					...
					else if(((Engine.engine.getGameAttribute("ask") : String) == "awake"))
					{
						showTileLayer(engine.getLayerByName("back1"));
				...
				{
					switchScene(GameModel.get().scenes.get(43).getID(), createFadeOut(1, Utils.getColorRGB(0,0,0)), createFadeIn(1, Utils.getColorRGB(0,0,0)));
				}
			}
		});

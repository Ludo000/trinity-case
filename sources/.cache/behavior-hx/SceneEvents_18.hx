...
class SceneEvents_18 extends SceneScript
{
	...
	override public function init()
	{
		...
		getActor(27).disableActorDrawing();
			...
			if(wrapper.enabled)
			{
				...
				if(((Engine.engine.getGameAttribute("NumDialogue") : Float) <= (Engine.engine.getGameAttribute("MaxDialogue") : Float)))
				{
					...
					if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_1"))
					{
						...
						getActor(27).enableActorDrawing();
						g.setFont(getFont(26));
						g.drawString("" + "- Rue Fleuve", (getActor(27).getX() + 20), (getActor(27).getY() + 50));
						g.drawString("" + "- Rue Fleurs", (getActor(27).getX() + 20), (getActor(27).getY() + 80));
						g.drawString("" + "- Rue Fautes", (getActor(27).getX() + 20), (getActor(27).getY() + 110));
						if(_HoverQCMChoix1)
						{
							g.fillColor = Utils.convertColor(Utils.getColorRGB(0,0,0));
							g.strokeSize = 5;
							g.drawRect((getActor(27).getX() + 15), (getActor(27).getY() + 45), 600, 30);
						}
						else if(_HoverQCMChoix2)
						{
							g.fillColor = Utils.convertColor(Utils.getColorRGB(0,0,0));
							g.strokeSize = 5;
							g.drawRect((getActor(27).getX() + 15), (getActor(27).getY() + 75), 600, 30);
						}
						else if(_HoverQCMChoix3)
						{
							g.fillColor = Utils.convertColor(Utils.getColorRGB(0,0,0));
							g.strokeSize = 5;
							g.drawRect((getActor(27).getX() + 15), (getActor(27).getY() + 105), 600, 30);
						}
					}
					else
					{
		...
		addMouseOverActorListener(getRegion(10), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				if(((Engine.engine.getGameAttribute("ask") : String) == "QCM_1"))
				{
					...
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Theodore : It's Rue Fleuve, an address, I must investigate here !";
		...
		addMouseOverActorListener(getRegion(11), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				...
				{
					playSound(getSound(224));
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Anna : It's not even near the railway, it can't be that ! : decu";
		...
		addMouseOverActorListener(getRegion(12), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				...
				{
					playSound(getSound(224));
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Anna : He don't talk about a road, it can't be that ! : decu";
					Engine.engine.setGameAttribute("Perd1Pv", true);
					Engine.engine.setGameAttribute("ShowNext", false);
					Engine.engine.setGameAttribute("ShowPrec", 1);
					Engine.engine.setGameAttribute("NumDialogue", ((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1));
		...
		addMouseOverActorListener(getRegion(9), function(mouseState:Int, list:Array<Dynamic>):Void
		{
			if(wrapper.enabled && 3 == mouseState)
			{
				...
				{
					playSound(getSound(224));
					(Engine.engine.getGameAttribute("LineList") : Array<Dynamic>)[Std.int(((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1))] = "Anna : He don't talk about a river, it can't be that ! : decu";
					Engine.engine.setGameAttribute("Perd1Pv", true);
					Engine.engine.setGameAttribute("ShowNext", false);
					Engine.engine.setGameAttribute("ShowPrec", 1);
					Engine.engine.setGameAttribute("NumDialogue", ((Engine.engine.getGameAttribute("NumDialogue") : Float) + 1));

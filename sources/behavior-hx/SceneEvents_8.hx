        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Anna:No, the video of the karaoke was never made public.";
        ...
        else if((Engine.engine.getGameAttribute("ask") == "QCM_2"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:The killer didn't make any mistake in the karaoke i don't think he would let that pass without noticing.";
            Engine.engine.setGameAttribute("Perd1Pv", true);
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("ShowPrec", 1);
            getActor(22).disableActorDrawing();
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Anna:The murder was recorded like the other on a camera.";
            getActor(22).disableActorDrawing();
            Engine.engine.setGameAttribute("ShowPrec", -1);
...
{
            playSound(getSound(156));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:Well it seems this guys is the only trail we have.";
            Engine.engine.setGameAttribute("ShowNext", true);
            getActor(22).disableActorDrawing();
            Engine.engine.setGameAttribute("ShowPrec", -1);
            Engine.engine.setGameAttribute("ask", "null");

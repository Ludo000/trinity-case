                ...
                else if(_HoverQCMChoix2)
{
            ...
            else if(((Engine.engine.getGameAttribute("ask") == "silence_musique") && !(_wasplayed)))
{
                stopAllSounds();
                loopSoundOnChannel(getSound(216), Std.int(0));
                _wasplayed = true;
...
{
            switchScene(GameModel.get().scenes.get(44).getID(), createFadeOut(1, Utils.getColorRGB(0,0,0)), createFadeIn(1, Utils.getColorRGB(0,0,0)));
}

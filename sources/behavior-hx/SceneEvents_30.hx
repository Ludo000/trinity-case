...
propertyChanged("_positionSurY", _positionSurY);
        ...
        _didsilmus = false;
propertyChanged("_didsilmus", _didsilmus);
        _didmusten = false;
propertyChanged("_didmusten", _didmusten);
        _HoverQCMChoix2 = false;
            ...
            if((0 < Engine.engine.getGameAttribute("ShowPrec")))
{
            ...
            if((Engine.engine.getGameAttribute("Levent") == "silence_musique"))
{
                if(!(_didsilmus))
{
                    _didsilmus = true;
propertyChanged("_didsilmus", _didsilmus);
            ...
            else if((Engine.engine.getGameAttribute("Levent") == "musique_tension"))
{
                if(!(_didmusten))
{
                    _didmusten = true;
propertyChanged("_didmusten", _didmusten);
                    playSoundOnChannel(getSound(155), Std.int(0));
}
            ...
            if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
                ...
                g.drawString("" + "- The killer is experienced.", (getActor(22).getX() + 20), (getActor(22).getY() + 50));
                g.drawString("" + "- It's the killer first kill.", (getActor(22).getX() + 20), (getActor(22).getY() + 80));
                if(_HoverQCMChoix1)
{
...
{
            switchScene(GameModel.get().scenes.get(31).getID(), createFadeOut(1, Utils.getColorRGB(0,0,0)), createFadeIn(1, Utils.getColorRGB(0,0,0)));
}
        ...
        if((Engine.engine.getGameAttribute("ask") == "QCM_1"))
{
            ...
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:I really hope it's not connected to the group of killer who roam the country.";
            getActor(22).disableActorDrawing();
...
{
            playSound(getSound(224));
            Engine.engine.getGameAttribute("LineList")[Std.int((Engine.engine.getGameAttribute("NumDialogue") + 1))] = "Theodore:No, all of this is way too perfect...";
            Engine.engine.setGameAttribute("ShowNext", false);
            Engine.engine.setGameAttribute("ShowPrec", 1);
            getActor(22).disableActorDrawing();
            Engine.engine.setGameAttribute("NumDialogue", (Engine.engine.getGameAttribute("NumDialogue") + 1));
